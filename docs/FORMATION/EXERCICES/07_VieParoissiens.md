...
1. Choisissez les fiches d’un couple marié.
2. Suivez les instructions indiquées dans le Mode d’Emploi : [https://uepal-civiparoisse-documentation.github.io/UTILISATION/mode_emploi/que_faire_quand.html#un-couple-divorce-ou-se-separe](https://uepal-civiparoisse-documentation.github.io/UTILISATION/mode_emploi/que_faire_quand.html#un-couple-divorce-ou-se-separe)
3. CONFIRMEZ que les opérations se sont déroulées comme indiquées.
4. Consultez la fiche de « l’ancien » foyer.
5. CONFIRMEZ que seul l’un des deux Individus est en relation avec ce Foyer.

## 005 - Enregistrer un mariage après divorce

1. Reprenez les deux fiches Individus utilisées dans le test ci-dessous.
2. Suivez les instructions indiquées dans le Mode d’Emploi : [https://uepal-civiparoisse-documentation.github.io/UTILISATION/mode_emploi/que_faire_quand.html#un-couple-se-marie](https://uepal-civiparoisse-documentation.github.io/UTILISATION/mode_emploi/que_faire_quand.html#un-couple-se-marie)
3. CONFIRMEZ que les opérations se sont déroulées comme indiquées.
4. Consultez la fiche du « nouveau » foyer.
5. CONFIRMEZ que le Foyer est bien en relation avec les deux Individus mariés.
...
1. Choisissez une Fiche Individu.
2. Suivez les instructions présentes dans le Mode d’Emploi : [https://uepal-civiparoisse-documentation.github.io/UTILISATION/mode_emploi/que_faire_quand.html#une-personne-quitte-la-paroisse](https://uepal-civiparoisse-documentation.github.io/UTILISATION/mode_emploi/que_faire_quand.html#une-personne-quitte-la-paroisse)
3. CONFIRMEZ que les opérations se sont déroulées comme indiquées.

## 012 - Enregistrer qu’une personne ne veut plus recevoir de communications

1. Choisissez une Fiche Individu.
2. Suivez les instructions indiquées dans le Mode d’Emploi : [https://uepal-civiparoisse-documentation.github.io/UTILISATION/mode_emploi/que_faire_quand.html#une-personne-ne-veut-plus-recevoir-de-communication](https://uepal-civiparoisse-documentation.github.io/UTILISATION/mode_emploi/que_faire_quand.html#une-personne-ne-veut-plus-recevoir-de-communication)
3. CONFIRMEZ que les opérations se sont déroulées comme indiquées.

## 013 - Enregistrer un PND (Pli Non Distribuable) 

1. Choisissez une Fiche Individu.
2. Suivez les instructions indiquées dans le Mode d’Emploi : [https://uepal-civiparoisse-documentation.github.io/UTILISATION/mode_emploi/que_faire_quand.html#un-courrier-revient-car-la-personne-a-change-dadresse](https://uepal-civiparoisse-documentation.github.io/UTILISATION/mode_emploi/que_faire_quand.html#un-courrier-revient-car-la-personne-a-change-dadresse)
3. CONFIRMEZ que les opérations se sont déroulées comme indiquées.

## 014 - Enregistrer un paroissien qui n’a pas d’adresse mail (ou qui ne peut pas la communiquer)
